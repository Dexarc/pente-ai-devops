...
variable "enable_custom_metric_autoscaling" {
  description = "Flag to enable custom metric-based auto-scaling for the ECS service."
  type        = bool
  default     = true
}

# Variables for Custom Metric Auto Scaling (passed from observability module outputs)
variable "custom_metric_filter_metric_name" {
  description = "The name of the custom metric generated by the CloudWatch Logs metric filter."
  type        = string
  # No default here, as it's expected to be passed from the observability module
}

variable "custom_metric_filter_namespace" {
  description = "The namespace of the custom metric generated by the CloudWatch Logs metric filter."
  type        = string
  # No default here, as it's expected to be passed from the observability module
}

variable "custom_scaling_target_value" {
  description = "The target value for the custom metric auto-scaling policy."
  type        = number
  default     = 50
}
